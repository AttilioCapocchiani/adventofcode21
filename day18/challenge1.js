class Node {
	...
	explode() {
		if (this.value !== -1 || this.depth !== 4) {
			return !!(this.left && this.left.explode()) || (!!this.right && this.right.explode())
		}
	...
	split() {
		if (this.value < 10) {
			return !!(this.left && this.left.split()) || !!(this.right && this.right.split());
		}
